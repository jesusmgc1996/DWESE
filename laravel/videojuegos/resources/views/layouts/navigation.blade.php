<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <x-nav-link :href="route('videogame.index')" :active="request()->routeIs('videogame.index')">
                            {{ __('Lista de videojuegos') }}
                        </x-nav-link>
                        <x-nav-link :href="route('videogame.create')" :active="request()->routeIs('videogame.create')">
                            {{ __('Añadir videojuego') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                <x-responsive-nav-link :href="route('videogame.index')" :active="request()->routeIs('videogame.index')">
                    {{ __('Lista de videojuegos') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('videogame.create')" :active="request()->routeIs('videogame.create')">
                    {{ __('Añadir videojuego') }}
                </x-responsive-nav-link>
