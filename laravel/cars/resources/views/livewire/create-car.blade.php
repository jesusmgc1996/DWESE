<div>
    <button type="button" wire:click='showForm()'
        ...
        coche</button>
    @if($show)
    <form wire:submit='save()' method="POST" class="max-w-md" enctype="multipart/form-data">
        @csrf
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" wire:model='plate' wire:model.blur='plate' name="plate" id="plate"
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" wire:model='brand' name="brand" id="brand"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " required />
            <label for="brand"
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" wire:model='year' wire:model.blur='year' name="year" id="year"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="year"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="date" wire:model='last_revision_date' name="last_revision_date" id="last_revision_date"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
